...
if($page.hasClass('ui-page') || $page.hasClass('clothing-page') || $page.hasClass('indesign-page')){
    classTab(6)
}else if($page.hasClass('graphic-page') || $page.hasClass('eshop-page')){
    classTab(5)
}
// 通用教师切换功能
...
function business(){
    //alert("我是执行链接到商务通")
    javascript:window.location.href='https://pbt.zoosnet.net/lr/chatpre.aspx?id=pbt40191642&lng=cn&r=&rf1=&rf2=&p=http%3a//m.jbsj.net/&cid=1526453420566530341134&sid=1529431968919544391231'
}
